...
with tf.Session() as sess:
    ...
    train_image, train_annotation,downsampled_logits_shape_r,upsampled_logits_shape_r = sess.run([image_tensor,
                                                                                                  annotation_tensor,
                                                                                                  downsampled_logits_shape,
                                                                                                  upsampled_logits_shape],
                                                                                                  feed_dict=feed_dict_to_use)

    print("train_annotation",train_annotation,train_annotation.shape)
    ...
    for i in range(10):
        ...
        print("pred_np.squeeze() != 1",(pred_np.squeeze() != 1))
...
#CRF code is able runing  ,detail unknow
